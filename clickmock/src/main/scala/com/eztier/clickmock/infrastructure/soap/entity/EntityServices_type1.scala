...
case class GetPORefsFromSnapshotResponse(getPORefsFromSnapshotResult: Option[com.eztier.clickmock.infrastructure.soap.entity.ArrayOfString] = None)
...
case class GetXmlStringsOfOidStrings(svcSessionToken: Option[String] = None,
  poRefStrings: Option[com.eztier.clickmock.infrastructure.soap.entity.ArrayOfString] = None)
      


case class GetXmlStringsOfOidStringsResponse(getXmlStringsOfOidStringsResult: Option[com.eztier.clickmock.infrastructure.soap.entity.ArrayOfString] = None)
...
case class InvokeInstanceMethod(svcSessionToken: Option[String] = None,
  poRefStr: Option[String] = None,
  methodName: Option[String] = None,
  args: Option[com.eztier.clickmock.infrastructure.soap.entity.ArrayOfAnyType] = None)
...
case class GetStorageListResponse(GetStorageListResult: Option[com.eztier.clickmock.infrastructure.soap.entity.ArrayOfString] = None)
